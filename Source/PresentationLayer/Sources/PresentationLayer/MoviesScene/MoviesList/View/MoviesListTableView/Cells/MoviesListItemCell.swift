...
final class MoviesListItemCell: UITableViewCell {
    ...
    private var posterImagesRepository: DomainLayer.PosterImagesRepository?
    private var imageLoadTask: Common.Cancellable? { willSet { imageLoadTask?.cancel() } }
    private let mainQueue: Common.DispatchQueueType = DispatchQueue.main
